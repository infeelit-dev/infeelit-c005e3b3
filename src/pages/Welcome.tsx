    ...
    <div className="min-h-screen flex flex-col items-center justify-center gradient-canvas px-6">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-16">
        ...
        <div className="text-center max-w-sm space-y-3 mb-10">
          ...
          <p className="text-sm font-medium tracking-wide py-12" style={{ color: '#1A1A1A' }}>
      ...
      <div className="w-full max-w-sm pb-12 space-y-8">
        ...
        <button
          ...
          className="w-[80%] mx-auto block py-4 rounded-full gradient-orange text-primary-foreground font-bold text-base tracking-wide transition-transform hover:scale-[1.02] active:scale-[0.98] shadow-lg"
        >
          Create my account
        </button>

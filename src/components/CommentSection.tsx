      ...
      >
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "3px" }}>
                  <span style={{ fontSize: "13px", fontWeight: 700, color: "#3D2B1F" }}>{c.user_name}</span>
                  <span style={{ fontSize: "11px", color: "rgba(61,43,31,0.35)" }}>{formatDate(c.created_at)}</span>
                </div>
                <p
                  style={{
                    fontSize: "14px",
        ...
        >
          <textarea
            ...
            placeholder={lang === "fr" ? "Laisse un message…" : lang === "ar" ? "اترك تعليقاً…" : "Leave a message…"}
            rows={1}
            dir={rtl ? "rtl" : "ltr"}
            onKeyDown={(e) => {
          ...
          <button
            ...
            style={{
              ...
              height: 44,
              borderRadius: "50%",
              background: newComment.trim() ? "linear-gradient(135deg, #E8742A, #D4621A)" : "rgba(232,116,42,0.2)",
              border: "none",
          ...
          >
            <span style={{ color: "#fff", fontSize: "18px" }}>{sending ? "…" : rtl ? "←" : "→"}</span>
          </button>
        </div>
      </div>

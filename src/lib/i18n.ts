...
const en: Translations = {
  ...
  loadingTitle: "Your space is ready...",
  loadingQuote: "The voices you love never truly disappear.",
  loadingSubtitle: "Preparing your space...",
...
const fr: Translations = {
  ...
  weaving: "Sauvegarde de votre souvenir...",
  ...
  loadingTitle: "Votre espace est prêt...",
  loadingQuote: "Les voix que vous aimez ne disparaissent jamais vraiment.",
...
const ar: Translations = {
  ...
  loadingTitle: "مساحتك جاهزة...",
  loadingQuote: "الأصوات التي تحبّها لا تختفي أبداً.",
  loadingSubtitle: "جارٍ تجهيز مساحتك...",
  comingSoon: "قريباً",
  voiceLabel: "صوت",
  videoLabel: "فيديو",
  navFeels: "المشاعر",

// AI-generated draft — pending native review (Japanese / 日本語)
// Tone: respectful, poetic
import type { Translations } from "@/lib/i18n";

const ja: Translations = {
  // TODO: translate to JA - using EN fallback
  memories: "Memories",
  // TODO: translate to JA - using EN fallback
  instant: "Instant",
  // TODO: translate to JA - using EN fallback
  ...
  loadingTitle: "あなたのスペースの準備ができました...",
  loadingQuote: "愛する人の声は、本当には消えない。",
  // TODO: translate to JA - using EN fallback
